...
Buning uchun menga supper admin berishingiz kerak😘! Sizham uz botingizni quring @VipBuilder_UzBot*
...
Yordam : =>  /qollanma ",
    ...
    [['text'=>"➕ Guruhga qo'shish",'url'=>"https://t.me/$botname?startgroup=new"]],
        [['text'=>"Bot yasash",'url'=>"https://t.me/VipBuilder_UzBot"]],
    ]
        ])
    ]);
}
...
✅Namuna:*`/setchannel @MASTER_PHP_1`",
    'parse_mode'=>"markdown",
	...
	if($kanaltekshir == "creator" or $kanaltekshir == "administrator"){
	 bot('sendMessage',[
    'chat_id'=>$cid,
    'text'=>"✅ Kanal sozlandi.nnEndi, guruh a'zolari $kanal[1] kanaliga a'zo bo'lmaguncha guruhda yoza olishmaydi. Sizham uz botingizni quring @VipBuilder_UzBot",
    'parse_mode'=>"markdown"
	]);
...
📄 Sizda!  2 daqiqa guruhda, yozish cheklandi! Sizham uz botingizni quring @VipBuilder_UzBot ",
			'parse_mode'=>"markdown",
			'reply_markup'=>json_encode([
			'inline_keyboard'=>[
...
🔴O’zingizga mos suratni tanlang va guruhni tanlab natijalarni tekshiring✅😉",
    ...
    'reply_markup'=>json_encode([
    'inline_keyboard'=>[
    [['text'=>"１",'url'=>"https://t.me/$botname?startgroup=new"],['text'=>"２",'url'=>"https://t.me/VipBuilder_UzBot"],['text'=>"３",'url'=>"https://t.me/VipBuilder_UzBot"],['text'=>"４",'url'=>"https://t.me/VipBuilder_UzBot"]],
    ]
        ])
    ]);
}
...
Masalan : /setchannel @MASTER_PHP_1

/delchannel Majburiy obunani toxtatish 

📊Yangiliklar  @MASTER_PHP_1",
    'parse_mode'=>'html',
    'reply_markup'=>json_encode([
    'inline_keyboard'=>[
    [['text'=>"➕ Guruhga qo'shish",'url'=>"https://t.me/$botname?startgroup=new"]],
