...
$rek = "Reklama: @VipBuilder_UzBot Sizham o'z botingizni quring";
///Ushbu kod @Mayli_me va @Qobilbek1 tomonidan @phpme_uz kanalida tarqatildi manba bilan oling!
///Ushbu kod @Mayli_me va @Qobilbek1 tomonidan @phpme_uz kanalida tarqatildi manba bilan oling!
///Ushbu kod @Mayli_me va @Qobilbek1 tomonidan @phpme_uz kanalida tarqatildi manba bilan oling!
...
'keyboard'=>[
[['text'=>"🛍Buyurtma Berish"],['text'=>"🔐 Mening hisobim"]],
...
$Telegram=json_encode([
  'inline_keyboard'=>[
  [['text'=>"🔰 Obunachi [Real members] 50₽",'callback_data'=>"Telegram=Obuna=598=50"]],
[['text'=>"🔸 Obunachi [Eron members] 40₽",'callback_data'=>"Telegram=Obuna=694=40"]],
[['text'=>"👁Ko‘rish [Arzon] 2₽",'callback_data'=>"Telegram=PM=498=2"]],
[['text'=>"👁Ko‘rish [Tez] 3₽",'callback_data'=>"Telegram=PM=272=3"]],
  [['text'=>"👁Ko‘rish [Oxirgi 5 post uchun] 10₽",'callback_data'=>"Telegram=PM=62=10"]],
  [['text'=>"$orqa",'callback_data'=>"back"]],
  ]
  ]);
$TikTok=json_encode([
  'inline_keyboard'=>[
  [['text'=>"⚫ Obunachi [Arzon] 40₽",'callback_data'=>"TikTok=Obuna=247=40"]],
  [['text'=>"👁Ko‘rish [Real] 20₽",'callback_data'=>"TikTok=PM=382=20"]],
  [['text'=>"$orqa",'callback_data'=>"back"]],
  ]
  ]);
$Instagram=json_encode([
  'inline_keyboard'=>[
  [['text'=>"🔒 Obunachi [Kafolatlangan] 35₽",'callback_data'=>"Instagram=Obuna=864=35"]],
  [['text'=>"👁 Ko'rish [post] 3₽",'callback_data'=>"Instagram=PM=421=3"]],
  [['text'=>"$orqa",'callback_data'=>"back"]],
  ]
  ]);
$YouTube=json_encode([
  'inline_keyboard'=>[
  [['text'=>"❤️ Obunachi [Kafolatlangan] 150₽",'callback_data'=>"YouTube=Obuna=5=150"]],
  [['text'=>"👁 Ko'rish [video] 50₽",'callback_data'=>"YouTube=PM=514=50"]],
  [['text'=>"$orqa",'callback_data'=>"back"]],
  ]
  ]);
...
bot('sendMessage',[ 
'chat_id'=>$admin, 
'text'=>"<i>Api kalitni  sozlash uchun yuboring, <b>uni ushbu @ArzonApiBot dan olasiz</b> ‼️.</i>", 
'parse_mode'=>'html', 
'reply_markup'=>$panel, 
]); 
