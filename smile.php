...
const API = "API_TOKEN"; // bot tokeni
...
$main = json_encode(['inline_keyboard'=>[
  ...
  [['text'=>"⤵️Do'stlarga yuborish", 'url' => "https://telegram.me/share/url?url=t.me/$botname da kulgili yuzni top o'yinini o'ynab ko'ring."]],   
...
$res = json_encode (['inline_keyboard'=>[
    ...
    [['text'=>'🔰 Bot haqida','callback_data'=>'about'], ['text'=>'⭐ Dasturchi','url'=>'t.me/EditUz_Bot']],
    ]
]);
$rest = json_encode (['inline_keyboard'=>[
    [['text'=>"🎉 O'yinni boshlash",'callback_data'=>'start']], 
  [['text'=>"⤵️Do'stlarga yuborish", 'url' => "https://telegram.me/share/url?url=t.me/$botname da kulgili yuzni top o'yinini o'ynab ko'ring."],  ['text'=>'⭐ Dasturchi','url'=>'t.me/EditUz_bot']],
    ]
]);
/////php  coder   Abdukhalilov Azim   t.me/Abdukhalilov_Azim
...
if($text=="/start"){
    send($cid,"👋Salom $name  men kulib turgan yuzni top o'yiniman.\n❗O'ynashdan oldin bot haqida bo'limi orqali botning strukturasi bilan tanishib chiqing Sizham o'z botingizni quring @EditUz_Bot",$res);
}
elseif($text=="/top"){
    send($cid,"➖➖➖🏆TOP 10🏆➖➖➖\n\n$top",$res);
}
