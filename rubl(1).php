...
<b>Rubl yechib olish uchun minimal summa:</b> <code>$minimalsumma</code> <b>rubl</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
...
if($sumid>=$minimalsumma){
 ...
 uzfox("sendMessage",[
    "chat_id"=>$chat_id,
              "text"=>"❗️Qiwi raqamingizni kiriting!\nNa'muna: 998xxxxxxxxx",
          "reply_markup"=>json_encode([
             "one_time_keyboard"=>true,
"resize_keyboard"=>true,
    "keyboard"=>[
...
stepbot($chatid,"summa");
              uzfox("sendMessage",[
                  "chat_id"=>$chatid,
                  "text"=>"💳 To'lov miqdorini kiriting.\n💰 Sizning hisobingizda: $hisob Rubl mavjud!",
"reply_markup"=>json_encode([
             "one_time_keyboard"=>true,
"resize_keyboard"=>true,
    "keyboard"=>[
