...
"inline_keyboard"=>[
[["text"=>"1️⃣ - Kanal","url"=>"https://t.me/$ch1"],["text"=>"2️⃣ - Kanal","url"=>"https://t.me/$ch2"],],
[["text"=>"3️⃣ - Kanal","url"=>"https://t.me/$ch3"],["text"=>"4️⃣ - Kanal","url"=>"https://t.me/$ch4"],],
[["text"=>"5️⃣ - Kanal","url"=>"https://t.me/$ch5"],["text"=>"🔔 - Homiy","url"=>"https://t.me/VipBuilder_UzBot"],],
...
function reyting(){
    $text = "🏆 <b>TOP 10 ta eng koʻp pul ishlagan foydalanuvchilar:</b>\n\n";
    $daten = [];
    $rev = [];
    $fayllar = glob("./uzfox/*.*");
...
$messagereply = $message->reply_to_message->message_id;
$ch9 = file_get_contents("ch9.txt");
$soat = date("H:i:s",strtotime("4 hour")); 
$sana = date("d/m/20y",strtotime("4 hour"));
...
$kanalss = file_put_contents("kanal/chatid.kanal4","$text");
$kanalsss = file_put_contents("kanal/chatid.kanal5","$text");
...
"resize_keyboard"=>true,
    "keyboard"=>[
[["text"=>"💸 Rubl ishlash"],["text"=>"💰 Balans"],],
[["text"=>"📒 Qo‘llanma"],["text"=>"🏆 Reyting"],],
[["text"=>"🔝 Bog‘lanish"],["text"=>"📊 Statistika"],],
]
]);
...
[["text"=>"📤 Minimal yechish"],["text"=>"📡 To‘lov kanali"],],
[["text"=>"👥 Referal narxini o'zgartirish"],["text"=>"⬅️ Ortga"],],
]
]);
...
if($text=="📡 To‘lov kanali" and $chatid==$admin){
typing($chatid);
uzfox('sendMessage',[
"chat_id"=>$chatid,
...
if($text=="📤 majburiy azolik" and $chatid==$admin){
typing($chatid);
uzfox('sendMessage',[
"chat_id"=>$chatid,
...
/ch4-kanaluseri @ belgisini qoymasdan! 
/ch5-kanaluseri @ belgisini qoymasdan! 
kanalingiz shaxsiy kanal bo'lmasin
xamma /ch1 /ch2 /ch3 /ch4 /ch5  larni aloxida xabar qilib yuboring! https://t.me/Edit_Uz/475</b>",
"parse_mode"=>"html",
"reply_markup"=>$panel,
]);
}
...
stepbot($chatid,"send_post");
      uzfox("sendMessage",[
      "chat_id"=>$chatid,
      "text"=>"<b>Rasmli xabar matnini kiriting. Xabar turi markdown: 
Tushunmasangiz https://t.me/Ultra_Pay/69</b>",
      "parse_mode"=>"html",
          "reply_markup"=>$panel,
          ]);
            }
...
<pre>[EditUz+https://t.me/VipBuilder_UzBot]\n[Yangiliklar+https://t.me/mayli_me]</pre>",
"parse_mode"=>"html",
                      "disable_web_page_preview"=>true,
                    ]);
...
uzfox("sendMessage",[
"chat_id"=>$admin,
"text"=>"<b>Minimal pul yechish narxi: $text rublga o'zgardi!</b>",
"parse_mode"=>"html",
"reply_markup"=>$panel,
]);
unlink("uzfoxbot/$chatid.step");
...
uzfox("sendMessage",[
    "chat_id"=>$chatid,
"photo"=>"",
    "text"=>"<b>Siz ham o'z botingizni yasang @VipBuilder_UzBot 
Hurmatli $firstname botimizdan pul ishlash uchun pastdagi referal havolani do‘stlaringizga ulashing va pul ishlang!</b>
...
if($text=="💰 Balans" and $ban==false){
if((joinchat($fromid)=="true") and (phonenumber($fromid)=="true") and ($ban==false)){
uzfox("sendMessage",[
"chat_id"=>$chatid,
"photo"=>"",
"text"=>"<b>Sizning balansingiz:</b> $sum <b>rubl</b>
...
if($sumid>=$minimalsumma){
 ...
 uzfox("sendMessage",[
    "chat_id"=>$chat_id,
          "text"=>"💰 <b>Sizning hisobingizda: $sumid rubl mavjud!</b>\n<b>Pulingizni yechib olish uchun hamyoni tanlang!</b>",
          "parse_mode"=>"html",
          "reply_markup"=>json_encode([
              "inline_keyboard"=>[
                  [["text"=>"🥝Qiwi","callback_data"=>"paynet"],],
...
if($sumid>=$minimalsumma){
 ...
 uzfox("sendMessage",[
    "chat_id"=>$chat_id,
              "text"=>"❗️ Qiwi hamyon raqamingizni kiriting!\nNa'muna: 998xxxxxxxxx",
          "reply_markup"=>json_encode([
             "one_time_keyboard"=>true,
"resize_keyboard"=>true,
    "keyboard"=>[
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"🤖 Bot ochish","url"=>"https://t.me/VipBuilder_UzBot"],],
]
]),
]);
}
...
"chat_id"=>$chatid,
"photo"=>"",
"text"=>"<b>Siz ham bot yaratishni xohlaysizmi @VipBuilder_UzBot
Savol - botda qanday qilib pul ishlash mumkin?</b>\n\n<b>Javob - botda pul ishlash juda oson, pul ishlash tugmasini bosing. Sizga berilgan unikal-havolani doʻstlaringizga yuboring. Doʻstingiz siz tarqatgan havola orqali botga kirib, bot bergan kanallarga a'zo bo‘lsa, biz sizning bot hisobingizga $referalsum rubl oʻtkazamiz.</b>\n\n<b>Qanday qilib pulni botdan chiqarish mumkin? Pullarni chiqarish to'g'ridan-to'g'ri sizning mobil telefoningizdagi Qiwi hamyonizga o'tqazdirip beriladi
🥝Qiwi platformasi .</b>",
"parse_mode"=>"html",
"reply_markup"=>$menu,
]);
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🔄 Yangilash","callback_data"=>"upgrade"],],
]
]),
]);
}
...
if($text=="🔝 Bog‘lanish" and $ban==false){
if((joinchat($fromid)=="true") and (phonenumber($fromid)=="true") and ($ban==false)){
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"<b>Admin bilan bog‘lanish!</b>

<i>Admin bilan bog‘lanish uchun pastagi 👤 Admin tugmasini bosing biz bilan faqat to‘lovlar haqida yozishingiz mumkin botdan tashqari savollar berish bloklanishga olib keladi!</i>

<b>Murojaat qilish: <a href='tg://user?id=$admin'>ADMIN</a></b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🛠️ Bot yaratish","url"=>"https://t.me/VipBuilder_UzBot"],],
]
]),
]);
}
...
"caption"=>"<b>Bot dasturchisi:</b> <a href='tg://user?id=>@VipBuilder_UzBot</a>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha</b>\n\n<b>Diqqat! Bot pul to'lab berish yoki to'lab bermasligiga dasturchi javobgar emas!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ Bogʻlanish","url"=>"https://t.me/mayli_me"],['text'=>"🛠️ Bot yaratish","url"=>"https://t.me/VipBuilder_UzBot"],],
]
]),
]);
}
