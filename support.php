...
Dasturchi👉 <a href = 'tg://user?id=$746250755'>UzBeKoDeR</a>

@Friends_Coder - Dasturlashni Biz Bilan Birga O'rganing!",
"parse_mode"=>"html",
'reply_markup' => json_encode([
                'inline_keyboard'=>[
                   [['text'=>'🆕Yangiliklar','callback_data'=>'yan']],
[['text'=>'🔰Kanalimiz','url'=>'https://t.me/Friends_Coder'],['text'=>'👤Admin','url'=>'https://t.me/UzBeKoDeR']], 
...
if($tx == "⭐"){
	bot('sendmessage',[
	'chat_id'=>$cid,
	'text'=>"<b>@Friends_Coder Jamoamizga Qoygan Ballingiz Uchun Rahmat!</b>",
'parse_mode'=>"html",
]);
bot('sendmessage',[
'chat_id'=>$admin,
