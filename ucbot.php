...
if($text=="💸 UC ishlash" and $ban==false){
...
uzfox("sendMessage",[
    "chat_id"=>$chatid,
"photo"=>"",
    "text"=>"<b>Hurmatli $firstname botimizdan Uc ishlash uchun pastdagi referal havolani do‘stlaringizga ulashing va pul ishlang!</b>
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"💰Uc ishlashni boshlash","switch_inline_query"=>$chatid],],
]
]),
]);
}
...
"chat_id"=>$chatid,
"photo"=>"",
"text"=>"<b>Sizning balansingiz:</b> $sum <b>Uc</b>
<b>Taklif qilgan do‘stlaringiz:</b> $referal <b>ta</b>
<b>Sizning raqamingiz:</b> +$contact

<b>Pul yechib olish uchun minimal summa:</b> <code>$minimalsumma</code> <b>Uc</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"📤 Uc yechish","callback_data"=>"production"],],
]
]),
]);
}
...
✅<b>Bot to‘lab bergan jami summa: $jami Uc </b>",
"parse_mode"=>"html",
"reply_markup"=>$menu,
]);
}
...
if($sumid>=$minimalsumma){
 ...
 uzfox("sendMessage",[
    "chat_id"=>$chat_id,
          ...
          "reply_markup"=>json_encode([
              "inline_keyboard"=>[
                  [["text"=>"PubG uc","callback_data"=>"paynet"],],
...
stepbot($chatid,"summa");
              uzfox("sendMessage",[
                  "chat_id"=>$chatid,
                  "text"=>"💳 To'lov miqdorini kiriting.\n💰 Sizning hisobingizda: $hisob Uc mavud!",
"reply_markup"=>json_encode([
             "one_time_keyboard"=>true,
"resize_keyboard"=>true,
    "keyboard"=>[
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"🤖 Bot ochish","url"=>"https://t.me/MakerPayBot"],],
]
]),
]);
}
