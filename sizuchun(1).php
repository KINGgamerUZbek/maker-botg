...
$key="whwjjeejej"; //api key partner.soc-proof.su saytidan olamz
$admin = "ADMIN_ID";
...
$rek = "Reklama: @VipBuilder_UzBot siz ham o'z botingizni yarating";
...
[['text'=>"📊 Buyurtmani kuzatish"]],[['text'=>"📨 Yordam"],['text'=>"📚 Bot haqida"]],
]
]);
$orqa="◀️Orqaga";
...
<a href='tg://user?id=$ex'>$ex</a> referalingizga pul berish uchun kanalimizga obuna boling</b>",
'parse_mode'=>'html',
]);
}
}
...
$nakrutka=json_encode([
  'inline_keyboard'=>[
[['text'=>"📨Telegram",'callback_data'=>"nakrutka=Telegram"],],
    ]
    ]);
...
'text'=>"
📚 Bot haqida:
●Bot 100% obunachi qo'shadi 
● Bot orqali Buyurtma berayotganda diqqatliroq bo'ling va noto'g'ri havola yubormang noto'g'ri havola uchun biz pulingizni   qaytarmaymiz❌❗️
●Botda referal havola orqali   odam taklif qilayotganingizda aslo qoʻshimcha akkauntlar yordamida yoki nakrutka referal yig'mang (chet el raqamlari)  agar sezib qolsak BAN⛔️ beramiz
● Operatorga yozganda o'z hurmatingizni biling 🔰
Agar buyurtmangiz 24 soat ichida bajarilmasa operatorga murojat qiling✅
 ●Hisobingizni to'ldirish uchun esa bemalol hohlagan vaqtingizda yozishingiz mumkin
●Botdagi maʼlumotlaringiz sir tutiladi va hech kimga aytilmaydi shu uchun ham botimiz Ishonchli ✔
●Operatorga yozganingizda kuting albatta javob beramiz☑️
● Buyurtmalar sekin bajarilishi mumkin shu uchun kuting 
Agarda 24 soat ichida buyurtmangiz🛍 bajarilmasa operatorga yozing tekshirib beriladi agar bajarilmagan bo'lsa pulingiz bot hisobingizga qaytarib beriladi🖇
Bot hisobingizni to'ldirish🛒 - @$adminuser ga Murojaat qiling 📨
...
$sana=date("d-M-20y",strtotime("2 hour"));
...
▶️ Botni ishlatish boʻyicha videolavha : 
➡️Botda obunachi qo'shish Pullik (tekinga urilmaydi)
🖇 Referal havola orqali ham pul ishlash mumkin 
🗄Hisobingizni to'ldirish uchun @$adminuser  ga Murojaat qiling ☑️
⏩ Botda Qiwi avtoto'lov mavjud 🐤 Hisobingizni admin orqali ishonchli toldirish imkoniyatiga  egasiz ✅
🤖Botdagi buyurtmalar avtomotik bajariladi ☑️
Bizni yangiliklar Kanalimizda kuzatib boring📢
Admin: @$adminuser",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
bot('sendMessage',[
'chat_id'=>$callcid,
'text'=>"Yuqoridagi xabarni tarqating va xar bir referalingiz uchun 150 so'm oling ",
]);
}
