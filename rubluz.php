...
[["text"=>"3️⃣ - Kanal","url"=>"https://t.me/$ch3"],["text"=>"4️⃣ - Kanal","url"=>"https://t.me/$ch5"],],
[["text"=>"🔔 - Homiy","url"=>"https://t.me/EditUz_Bot"],],
...
xamma /ch1 /ch2 /ch3 larni aloxida xabar qilib yuboring! https://t.me/Edit_Uz/475</b>",
"parse_mode"=>"html",
"reply_markup"=>$panel,
]);
}
...
uzfox("sendMessage",[
    "chat_id"=>$chatid,
"photo"=>"",
    "text"=>"<b>Siz ham o'z botingizni yasang @EditUz_Bot 
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"🤖 Bot ochish","url"=>"https://t.me/EditUz_Bot"],],
]
]),
]);
}
...
"chat_id"=>$chatid,
"photo"=>"",
"text"=>"<b>Siz ham bot yaratishni xohlaysizmi @EditUz_Bot
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🛠️ Bot yaratish","url"=>"https://t.me/EditUz_Bot"],],
]
]),
]);
}
...
"caption"=>"<b>Bot dasturchisi:</b> <a href='tg://user?id=>@EditUz_Bot</a>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha</b>\n\n<b>Diqqat! Bot pul to'lab berish yoki to'lab bermasligiga dasturchi javobgar emas!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ Bogʻlanish","url"=>"https://t.me/mayli_me"],['text'=>"🛠️ Bot yaratish","url"=>"https://t.me/edituz_bot"],],
]
]),
]);
}
